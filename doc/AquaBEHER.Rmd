...
For many agricultural applications, it is relevant to get an estimate on the potential evapotranspiration (PET). Different methods are developed for estimating Eto. Most of them use emprical equations to determine the value of Eto from weather variables. The AquaBEHER package provides opsions for estimating Eto using the FAO Penman-Monteith, Priestley Taylor and Hargreaves-Samani formulations.
...
It appears that the FAO Penman–Monteith formulation presents enhanced day-to-day variations of evapotranspiration than the the Hargreaves-Samani formulation.
