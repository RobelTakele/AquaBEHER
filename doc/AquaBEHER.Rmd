...
<img align="right" width="300" src="tools/Evapotranspiration.gif" alt="Evapotranspiration cycle">
 ...
 * The function returnes a list of
...
calender year starting from the driest month and has a fixed length of 12 months.
...
Such a period meets the evapotransiration demands of crops and recharge the 
...
categorised by quantiles of seasonal rainfall totals associated with that 
...
Finaly the ensemble members are converted to WSC tercile probabilites.
...
$$\\[0.2in]$$
  ...
  The Genetics Group at the **Institute of Plant Sciences** is a geographically and culturally diverse research team working on data-driven agicultural innovation combining crop genetics, climate, and participatory approaches. We are based at **Scuola Superiore Sant’Anna**, Pisa, Italy.
